...
public class FileMoveCommand : ICommand
{
    ...
    public FileMoveCommand(string sourcePath, string destinationPath, ILogger logger)
    {
    ...
    public void Execute(FileSystemWorkingDirectory fileSystemWorkingDirectory)
    {
        ...
        {
            File.Move(absolutSourcePath, absolutDestinationPath);

            _logger.Log("file " + name + " successfully moved from: " + absolutSourcePath +
